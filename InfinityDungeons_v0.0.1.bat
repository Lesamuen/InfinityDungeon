...
:something
cls
echo You are playing Infinity Dungeons Alpha v0.0.1
echo Are you sure you want to contiue? (yes or no)
set /p somethingelse=
...
echo Sorry! Finding items hasn't been added yet!
goto main
:randommonster
echo A random monster attacks you!
echo Sorry! Monsters haven't been added yet!
goto main
:safe
...
echo Sorry! Traps haven't been added yet!
goto main
:die
set health=0
echo You have died!
