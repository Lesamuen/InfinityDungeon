...
:something
cls
echo You are playing Infinity Dungeons Pre-Alpha v0.0.8
...
:hit
cls
echo You hit the %monstername% for %damage% damage!
echo.
set /a monsterhealth=%monsterhealth%-%damage%
pause >nul
echo The %monstername% hits you for %monsterdamage% damage!
set /a health=%health%-%monsterdamage%
pause >nul
goto fight
:inventory
cls
