...
:something
cls
echo You are playing Infinity Dungeons Pre-Alpha v0.0.9
...
if %nextmove% == ruinthefun goto ruinthefun
cls
echo That is an invalid command!
goto main
:ruinthefun
set head=Hax Helmet
set torso=Hax Chestplate
set legs=Hax Leggings
set footwear=Hax Boots
set weapon=Hax Blade
set headdesc=Part of the "Ruin-The-Fun" equipment set.
set torsodesc=Part of the "Ruin-The-Fun" equipment set.
set legsdesc=Part of the "Ruin-The-Fun" equipment set.
set footweardesc=Part of the "Ruin-The-Fun" equipment set.
set weapondesc=Part of the "Ruin-The-Fun" equipment set.
set strength=999999999
set wisdom=999999999
set armor=999999999
set damage=999999999
cls
echo Success!
goto main
:helpdungeon
...
echo.
echo ruinthefun : Ruins the fun of the game
pause >nul
cls
goto main
:save
...
if %nextmove% == stats goto statsfight
...
echo.
echo stats : Shows you your current stats
echo.
...
::TODO
::Make Items Mechanism
::Add Magical Weapontype