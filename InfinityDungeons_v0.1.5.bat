...
:something
cls
echo You are playing Infinity Dungeons Beta v0.1.5
...
set /a monsterxpdrop=%RANDOM% %% (%monsterlvl% * 10)
...
set /a monsterlvldamage=%monsterlvl% * (%RANDOM% %% 10)
...
if %currxp% == %xptolevel% set /a xptolevel=%level% * 7
...
if %currxp% GTR %xptolevel% set /a xptolevel=%level% * 7
