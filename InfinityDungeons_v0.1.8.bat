...
:something
cls
echo You are playing Infinity Dungeons Release v0.1.8
...
:load29
for /f "usebackq skip=28 delims=." %%a in ("IDSaveFile.txt") do (set damage=%%a&cls&echo Success!&goto main)
cls
