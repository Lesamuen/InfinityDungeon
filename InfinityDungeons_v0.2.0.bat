...
:something
cls
echo You are playing Infinity Dungeons Release v0.2.0
...
goto main
:load1
for /f "usebackq skip=0 delims=." %%a in ("IDSaveFile.txt") do (set head=%%a&goto load2)
:load2
...
:load34
for /f "usebackq skip=33 delims=." %%a in ("IDSaveFile.txt") do (set companiondamage=%%a&cls&echo Success!&goto main)
cls
...
if %compprefix% == Godly set compprefixstrength=50&set compprefixwisdom=50&set compprefixarmor=100&set compprefixdamage=100
...
set /a complvlstrength=%complvl% * (%RANDOM% %% 15)
set /a complvlwisdom=%complvl% * (%RANDOM% %% 15)
set /a complvlarmor=%complvl% * (%RANDOM% %% 10)
set /a complvldamage=%complvl% * (%RANDOM% %% 10)
...
set /p nextmove=
if %nextmove% == yes set companion=%compname%&set companionstrength=%compstrength%&set companionwisdom=%compwisdom%&set companionarmor=%comparmor%&set companiondamage=%compdamage%&cls&echo You took the %companion%!&goto calcstats
...
echo.
echo Your companion is %companion%
...
set /a monsterlvldamage=%monsterlvl% * (%RANDOM% %% 25)
set /a monsterlvlarmor=%monsterlvl% * (%RANDOM% %% 15)
set /a monsterlvlhealth=%monsterlvl% * (%RANDOM% %% 10)
set /a monsterdamage=%monsterprefixdamage%+%monsterrankdamage%+%monsterlvldamage%
set /a monsterhealth=%monsterprefixhealth%+%monsterrankhealth%+%monsterlvlarmor%
set /a monsterarmor=%monsterprefixarmor%+%monsterrankarmor%+%monsterlvlhealth%
goto fight
:safe
cls
