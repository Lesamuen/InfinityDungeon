...
:something
cls
echo You are playing Infinity Dungeons Release v0.2.1
...
:load35
for /f "usebackq skip=34 delims=." %%a in ("IDSaveFile.txt") do (set healthpotions=%%a&cls&echo Success!&goto main)
cls
