...
:something
cls
echo You are playing Infinity Dungeons Release v0.2.2
...
set /a monsterlvldamage=%monsterlvl% * (%RANDOM% %% 50)
set /a monsterlvlarmor=%monsterlvl% * (%RANDOM% %% 10)
set /a monsterlvlhealth=%monsterlvl% * (%RANDOM% %% 15)
