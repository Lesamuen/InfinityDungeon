...
:something
cls
echo You are playing Infinity Dungeons Release v0.2.3
...
:load35
for /f "usebackq skip=34 delims=." %%a in ("IDSaveFile.txt") do (set companiondamage=%%a&goto load36)
:load36
for /f "usebackq skip=35 delims=." %%a in ("IDSaveFile.txt") do (set healthpotions=%%a&cls&echo Success!&goto main)
cls
